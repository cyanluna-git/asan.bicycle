...
import { WIND_COLORS, WIND_LABELS, type WindSegment } from '@/lib/wind-analysis'

interface WindStripChartProps {
  segments: WindSegment[]
  hoveredDistanceKm?: number | null
  onHoverDistanceChange?: (distanceKm: number | null) => void
}

export function WindStripChart({
  segments,
  hoveredDistanceKm,
      ...
      >
        <div className="flex items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-2">
            {(['headwind', 'tailwind', 'crosswind'] as const).map((key) => (
